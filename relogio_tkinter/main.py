...
saudacao = Label(root, bg='#1d1d1d', fg='#8e27ea', font=('8514oem', 20))
saudacao.pack()


data = Label(root, bg='#1d1d1d', fg='#8e27ea', font=('8514oem', 16))
data.pack(pady=2)

horas = Label(root, bg='#1d1d1d', fg='#8e27ea', font=('8514oem', 30, 'bold'))
horas.pack(pady=2)
